...
int hard_voxelize_gpu(const at::Tensor& points, at::Tensor& voxels,
    ...
    std::cout << "dynamic_voxelize_kernel time=" << std::chrono::duration_cast<std::chrono::microseconds>(end - start).count() / 1000.0 << "ms" << std::endl;
    ...
    cudaDeviceSynchronize();
        ...
        std::cout << "point_to_voxelidx_kernel time=" << std::chrono::duration_cast<std::chrono::microseconds>(end - start).count() / 1000.0 << "ms" << std::endl;
...
//    AT_CUDA_CHECK(cudaGetLastError());
    ...
    cudaDeviceSynchronize();
        ...
        std::cout << "determin_voxel_num time=" << std::chrono::duration_cast<std::chrono::microseconds>(end - start).count() / 1000.0 << "ms" << std::endl;
//    AT_CUDA_CHECK(cudaGetLastError());
    ...
    cudaDeviceSynchronize();
        ...
        std::cout << "assign_point_to_voxel time=" << std::chrono::duration_cast<std::chrono::microseconds>(end - start).count() / 1000.0 << "ms" << std::endl;
    //   AT_CUDA_CHECK(cudaGetLastError());
    ...
    cudaDeviceSynchronize();
        ...
        std::cout << "assign_voxel_coors time=" << std::chrono::duration_cast<std::chrono::microseconds>(end - start).count() / 1000.0 << "ms" << std::endl;
    AT_CUDA_CHECK(cudaGetLastError());
...
void dynamic_voxelize_gpu(const at::Tensor& points, at::Tensor& coors,
    ...
    AT_CUDA_CHECK(cudaGetLastError());
    auto end = std::chrono::steady_clock::now();
    std::cout << "voxelization_cuda.cu time=" << std::chrono::duration_cast<std::chrono::microseconds>(end - start).count() / 1000.0 << "ms" << std::endl;
    return;
}
